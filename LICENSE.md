...
> Discord image manipulation bot, filters memes overlays 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎨 &nbsp;**Filters** — apply filters and effects to any image

🖼️ &nbsp;**Meme overlays** — classic and custom meme templates

👤 &nbsp;**Avatar manipulation** — fun effects on profile pics

✂️ &nbsp;**Background remove** — AI-powered background remover

📐 &nbsp;**Resize & crop** — adjust image dimensions

💾 &nbsp;**Convert** — convert between PNG, JPEG, WebP, GIF
